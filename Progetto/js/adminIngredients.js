...
fetch('port.txt')
    ...
    .then(myPort => {
        ...
        const urlIngredients = 'http://localhost:' + myPort + '/adminIngredients/all'
        ...
        add_product_BTN.onclick = function() {
            ...
            if (name.length > 0 && qty.length > 0) {
                ...
                const urlAdd = 'http://localhost:' + myPort + '/adminIngredients'
        ...
        function createNewForm(product) {
            ...
            buttonDelete.onclick = function() {
                ...
                const urlRemove = 'http://localhost:' + myPort + '/adminIngredients/' + product['id'];
