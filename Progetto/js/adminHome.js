...
fetch('port.txt')
    ...
    .then(myPort => {
        ...
        const urlProducts = 'http://localhost:' + myPort + '/adminHome'
        ...
        function createNewForm(product, x) {
            ...
            buttonEye.onclick = function() {
                const quickViewURL = 'http://localhost:' + myPort + '/quickViewAdmin/';
            ...
            buttonDelete.onclick = function() {
                ...
                const urlCart = 'http://localhost:' + myPort + '/adminHome/' + product['id'];
