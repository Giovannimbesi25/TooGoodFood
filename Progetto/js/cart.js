    ...
    .then(myPort => {
        ...
        function createNewForm(product, x, user_id) {
            ...
            buttonDelete.onclick = function() {
                ...
                const urlCart = 'http://localhost:' + myPort + '/cart/' + user_id;
        ...
        async function getUser() {
            ...
            if (user_id) {
                ...
                const cartURL = 'http://localhost:' + myPort + '/cart/' + user_id;
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            ...
                            if (list_products.length > 0) {
                                ...
                                const userURL = 'http://localhost:' + myPort + '/profile';
                                const myData = {
                                    id: user_id
                                }
                                fetch(userURL, {
                                    ...
                                    .then(function(data) {
                                        ...
                                        function checkInIntervals(howManyTimes, howOften) {
                                            ...
                                            var interval = setInterval(function() {
                                                ...
                                                async function getProductsIngredients(quantita, queryProduct) {
                                                    var myIngredients;
                                                    var quickViewURL = 'http://localhost:' + myPort + '/quickView/' + list_products[i]['pid'];
                                                    ...
                                                    checkIngredienti(myIngredients, quantita, queryProduct).then(function(data) {
                                                        ...
                                                        if (tuttoOK) {
                                                            ...
                                                            const updateIngredientiURL = 'http://localhost:' + myPort + '/ingredienti/update'
                                                            for (var i = 0; i < myIngredients.length; i++) {
                                                                var mySplit = myIngredients[i].split(':');
                                                                const myData = {
                                                                    name: mySplit[0],
                                        ...
                                        function resultOrder() {
                                            ...
                                            if (!result) {
                                                ...
                                                const updateIngredientiURL = 'http://localhost:' + myPort + '/ingredienti/revert'
                                                ...
                                                const orderURL = 'http://localhost:' + myPort + '/orders';
                                                fetch(orderURL, {
                                                        method: 'POST',
                                                        headers: {
                                                            'Content-Type': 'application/json'
